...
function radix_starter_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form_state['build_info']['files']['form'] = drupal_get_path('theme', 'retebuonvivere') . '/theme-settings.php';

  // Add theme settings here.
  $form['retebuonvivere_theme_settings'] = array(
    '#title' => t('retebuonvivere'),
    '#type' => 'fieldset',
  );

  // Copyright.
  $copyright = theme_get_setting('copyright');
  $form['retebuonvivere_theme_settings']['copyright'] = array(
    '#title' => t('Copyright'),
    '#type' => 'text_format',
